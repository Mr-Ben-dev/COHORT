...
Designer UI (`https://cohort-web-orcin.vercel.app`) → 1AM `connect('preprod')` in the Connect click → `getProvingProvider` → `submitCallTx` (2026-09-13 utility-upgrade prove, NCT07153614 typed subset, Connect was a user gesture): txId `00cc4e4631c26250628f3b68fea771f1520b9f49316d7d8a7cb588ab48309599d9`, txHash `97308434388cdba0a83eec487a1cee3645b7eead9c8836ce457c3de84132e1c8`, indexer `proveEligible` **SUCCESS** in block 2524713, **proven=5**. Prior honesty-pass prove: txId `003e8f36bcda1e2a9d9f50926b2cfcc8db16f9c931529b3af0d0e4c6ee0f4692c1`, txHash `40527ba6332a5953533d696c5ebc090ed1f168a84f00e53ac02d2251b68c4276`, block 2523970, then proven=4. Prior designer prove: txId `002eae475d5850831fa0bc57d4e7fc179f44bda724ead7697475bae7371dc24c35`, txHash `0e8b61cbeb1d4b044743f8512b1d1bebb4d048d4dde091af5ce992ba701a4bd0`, block 2523192, then proven=3. Prior same-origin stub prove (2026-09-12, live Render): txId `000657e4fb84d31e2426814305fca09a4af4b0abcf24417b176420eae0aa3a9867`, txHash `3b1624e9cc8c17808f67cb5c52244f197fe57c0c820c75ef5beb7e18b8bf1590`, then proven=2. The Node SDK prove (`00e53324…`) is not this path.
...
Cursor attaches to this Chrome + 1AM/Lace profile through [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) `--autoConnect` (Chrome 144+). Enable `chrome://inspect/#remote-debugging` and click **Allow**. Do not use `--browser-url=http://127.0.0.1:9222` on this Chrome 152 — `/json/version` is 404; attach via `DevToolsActivePort` WebSocket. A dedicated debug Chrome would not carry the 1AM session. Connect / Approve stay a real user gesture — CDP must not click Connect (it poisons 1AM). Never extract a 1AM seed.
